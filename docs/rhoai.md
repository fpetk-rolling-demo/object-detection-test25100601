...
3) Access the `workbench` named `object-detection-test25100601-notebook`.
...
5) In the terminal, run `cd object-detection-test25100601` to navigate to your sample app's directory.
